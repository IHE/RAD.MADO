...
* identifier 1..1 MS
  * ^short = "An OID according to the DICOM value representation UI for a FHIR-Based formatted Imaging Study Manifest. This field will hold the same value that could be used as the SOP Instance UID of the corresponding translated DICOM KOS manifest."
